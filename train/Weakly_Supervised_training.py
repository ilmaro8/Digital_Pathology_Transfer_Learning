...
MODELS_PATH = #PATH_MODEL_WEAK_SUPERVISION
MODELS_PATH = MODELS_PATH + 'weak_supervision/'
...
#model_filename = models_path+'mobilenet_finetune_WSI_class_weak_augment.h5'
model_filename = models_path+'mobilenet_weak_supervision.h5'
...
history_filename = models_path+'history/history_finetune_weak.json'
