...
PERCENTAGE_DATA_str = str(PERCENTAGE_DATA)
	...
	#if percentage
data_folder = #CSV_FOLDER_DIR
percentage_folder = data_folder + 'perc_' + PERCENTAGE_DATA_str + '/'
csv_train = percentage_folder + 'train.csv'
csv_valid = percentage_folder + 'valid.csv'

MODELS_PATH = #MODEL_PATH
MODELS_PATH = MODELS_PATH + 'fully_supervision/'
...
model_filename = models_path+'mobilenet_fully_supervision.h5'
