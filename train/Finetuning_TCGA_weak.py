...
models_path = '/projects/0/examode/examode_experiments/Strong_labels_experiment/StrongLabeledNetwork/model_weights/finetuning/weak_finetuning/exp_'+N_EXP+'/'
...
model_filename = models_path+'mobilenet_finetune_WSI_class_weak.h5'
